...
const RecommendBooks_detail = ({ genreCount, setShowBookDetail }: RecommendBooks_detailProps) => {
    const { bookList, favorites } = useContext(BookContext) as bookContextType
    ...
    return (
        <div>
            <ShowMiniBook setShowBookDetail={setShowBookDetail} showFrom={'recommended'} />
        </div >
    )
};
